       ...
       // buttonMemory8 = findViewById(R.id.idMAButtonStoreData8);
        ...
        buttonShare.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intentShare.putExtra(Intent.EXTRA_SUBJECT,"Share Bluetooth Test message");
                intentShare.putExtra(Intent.EXTRA_TEXT,tvReceivedMessage.getText().toString());
                startActivity(Intent.createChooser(intentShare, "Sharing Bluetooth Test"));
